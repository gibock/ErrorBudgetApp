...
import com.example.budgetapp.util.InternalStoragePhoto
...
class ProfileFragment : Fragment(R.layout.fragment_profile) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myPref = requireContext().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE)
    ...
    private fun saveImageToInternalStorage(fileName: String, bitmap: Bitmap): Boolean {
        return try {
            requireContext().openFileOutput("$fileName.jpg", Context.MODE_PRIVATE).use { outputSream ->
